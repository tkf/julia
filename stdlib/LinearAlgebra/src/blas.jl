...
using LinearAlgebra: USE_LIBBLASTRAMPOLINE
...
if USE_LIBBLASTRAMPOLINE
    ...
    set_num_threads(nt::Integer)::Nothing =
        ccall((@blasfunc(openblas_set_num_threads), libblas), Cvoid, (Cint,), nt)
end
